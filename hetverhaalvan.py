            ...
            if kamal1 == "1":
                ...
                if kamal2 == "ja":
                    ...
                    if opnieuw == "ja":
                        ...
                        print("Helaas! Graag vraag ik uw wel om verhalen op de website van Stichting VluchtelingenWerk te gaan lezen.")
                        print("Wil je vluchtelingen verhalen lezen? Ja/Nee")
                        verhaallezen = input().lower()
                        if verhaallezen == "ja":
                            webbrowser.open('https://www.vluchtelingenwerk.nl/')
                            print("Het programma word nu afgesloten.")
                        elif verhaallezen == "nee":
                            print("Jammer, ik sluit nu af.")
                        else:
